...
error_exit() {
  echo "${1:-"
Unknown Error, execution halted "}" 2>&1 | tee doitgromacs.log 
  echo ""
  exit 1
}
...
helpMessage() {
  cat <<EOF
    ...
    NOTE 1: The script recognise three machines: acrm/emerald/lappy.
...
:'  $RscriptEXE /export/francesco/Dropbox/scripts/Rscripts/Rplots/grom_rgyrSing.R   \
       $nameprod"_rgyration.xvg"
   mv rgyr.png $name1"_rgyr.png"
   $RscriptEXE /export/francesco/Dropbox/scripts/Rscripts/Rplots/grom_rmsfSing.R   \
      $nameprod"_rmsf_bb.xvg" $nameprod"_rmsf_sc.xvg"
   mv rmsf.png $name1"_rmsf.png"
   $RscriptEXE /export/francesco/Dropbox/scripts/Rscripts/Rplots/grom_rmsdSing.R   \
      $nameprod"_rmsd.xvg"
   mv rmsd.png $name1"_rmsd.png"
   $RscriptEXE /export/francesco/Dropbox/scripts/Rscripts/Rplots/grom_ssSing.R     \
      $nameprod"_ss_count.xvg"
   mv SStructure.png $name1"_ssCount.png"
   $RscriptEXE /export/francesco/Dropbox/scripts/Rscripts/Rplots/grom_SimCond_args.R \
      $nameprod"_potential.xvg" $nameprod"_temperature.xvg" \
      $nameprod"_pressure.xvg" $nameprod"_density.xvg"
